...
import com.example.openai.utils.HelpDeskTools;
...
public class HelpDeskController {
    ...
    public ResponseEntity<String> helpDesk(@RequestHeader("username") String username,
        ...
        String answer = chatClient.prompt().advisors(advisorSpec -> advisorSpec.param(CONVERSATION_ID, username))
                .user(message).tools(helpDeskTools).toolContext(Map.of("username", username)).call().content();
